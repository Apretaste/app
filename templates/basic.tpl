...
<p>1) Si desea descargar la app lista para instalar (2,62 MB), presione el siguiente link: [{link href="APP APK" caption ="Descargar APK"}]</p>

<p>2) Si desea descargar la app comprimida en formato RAR (1.90 MB), presione el siguiente link: [{link href="APP RAR" caption ="Descargar RAR"}]</p>
